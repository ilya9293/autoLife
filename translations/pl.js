const plTranslation = {
  header: {
    main: "Główny",
    aboutUs: "O nas",
    placingOrder: "Składając zamówienie",
    costParcel: "Koszt paczki",
  ...
  hero: {
    ...
    countries: "Ukrainą a Polską",
    cost: "Oblicz koszt",
  },
  services: {
    company: "Firma kurierska",
    avto: "Auto-life_PL",
    delivery: {
      title: "Dostawa paczki",
      text: "Doręczenie przesyłek z Ukrainy do Polski oraz z Polski na Ukrainę odbywa się w terminie uzgodnionym z dyspozytorem",
    },
    shipping: {
      title: "Przewóz pasażerów",
      text: "Bezpieczny transport pasażerów odbywa się minibusami do miejsca docelowego.",
    },
    doc: {
      title: "Dostawa dokumentów",
      text: "Doręczenie dokumentów w Polsce odbywa się z ręki do ręki odbiorcy, na Ukrainie są one wysyłane przez Nova Poshta pod wskazany adres",
    },
    med: {
      title: "Dostawa leków",
      text: "Dostawa jest bezpłatna, płacisz tylko za koszt leku",
    },
    zsu: {
      title: "Dostawa do Sił Zbrojnych",
      text: "Dostawa do Sił Zbrojnych",
    },
    order: {
      title: "Dostawa zamówień internetowych",
      text: "Dostawa zamówień internetowych następuje po opłaceniu zamówienia w sklepie internetowym",
    },
  },
  about: {
  ...
  steps: {
    ...
    passanger: "Pasażer",
    send: {
      title: "Wyślij zamówienie wiadomością w Viber, WhatsApp, Telegram",
    ...
    direct: {
      ...
      adress: "Adres (gdzie dostarczyć przesyłkę)",
      number: "Numer oddziału Nova Postta",
      name: "Nazwisko odbiorcy.",
    },
    taking: {
      title: "Kierowca odbiera paczkę od klienta",
      text: "Kierowca uprzedza o swoim przyjeździe, odbiera przesyłkę w Polsce i dostarcza ją na Ukrainę.",
    },
    takePost: {
      title: "Odbiorca odbiera przesyłkę z Nowej Poczty",
      text: "Paczki na Ukrainie są wysyłane przez Nova Poshta.",
    },
    coordinates: {
      title: "Wyślij współrzędne pasażera",
      name: "Pełne imię i nazwisko",
      from: "Gdzie::",
      where: "Do:",
    },
    giveLift: {
      title: "Kierowca zabiera pasażera",
      text: "W Polsce kierowca odbiera pasażera pod wskazany adres, na Ukrainie kierowca odbiera pasażera pod dowolnym adresem na dworcu",
    },
    atPlace: {
      title: "Jesteś na miejscu!",
      text: "Pasażer dotarł do celu.",
    },
  },
  cost: {
